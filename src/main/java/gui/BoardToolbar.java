...
class BoardToolbar extends JPanel {
    ...
    BoardToolbar(BoardFrame p_board_frame) {
        ...
        ResourceBundle resources
                = ResourceBundle.getBundle("gui.resources.BoardToolbar", p_board_frame.get_locale());
        ...
        select_button = new JToggleButton();
        route_button = new JToggleButton();
        drag_button = new JToggleButton();
        final JLabel jLabel1 = new JLabel();

        left_toolbar.setMaximumSize(new Dimension(1200, 23));
        ...
        route_button.addActionListener(e -> {
        ...
        drag_button.addActionListener(e -> {
        ...
        add(left_toolbar, BorderLayout.WEST);
        ...
        autoroute_button.addActionListener(e -> {
        ...
        incompletes_button.addActionListener(e -> {
        ...
        violation_button.addActionListener(e -> {
        ...
        display_all_button.addActionListener(e -> {
        ...
        unit_label.setMaximumSize(new Dimension(30, 21));
        unit_label.setPreferredSize(new Dimension(30, 21));
    ...
    void hilight_selected_button() {
        interactive.InteractiveState interactive_state = board_frame.board_panel.board_handling.get_interactive_state();
