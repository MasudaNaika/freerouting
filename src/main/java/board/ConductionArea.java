...
public class ConductionArea extends ObstacleArea implements Connectable {
    ...
    public Item copy(int p_id_no) {
        ...
        return new ConductionArea(get_relative_area(), get_layer(), get_translation(), get_rotation_in_degree(),
                ...
                name, is_obstacle, get_fixed_state(), board);
    }
    ...
    /**
     * Returns if this conduction area is regarded as obstacle to traces of
     * foreign nets.
     */
    ...
    /**
     * Sets, if this conduction area is regarded as obstacle to traces and vias
     * of foreign nets.
     */
