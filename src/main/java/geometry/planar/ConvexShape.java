 ...
 * contained in the shape the whole segment is contained completely in the
 * shape.
 *
 * @author Alfons Wirtz
 */
public interface ConvexShape extends Shape {
    ...
    /**
     * Calculates the offset shape by p_distance. If p_distance > 0, the shape
     * will be enlarged, else the result shape will be smaller.
     */
