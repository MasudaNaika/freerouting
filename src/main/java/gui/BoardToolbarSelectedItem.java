...
class BoardToolbarSelectedItem extends JToolBar {
    ...
    BoardToolbarSelectedItem(BoardFrame p_board_frame, boolean p_extended) {
        ...
        resources
                = ResourceBundle.getBundle("gui.resources.BoardToolbarSelectedItem", p_board_frame.get_locale());
        ...
        cutout_button.addActionListener(e -> {
        ...
        fix_button.addActionListener(e -> {
        ...
        unfix_button.addActionListener(e -> {
        ...
        tidy_button.addActionListener(e -> {
        ...
        clearance_class_button.addActionListener(e -> {
        ...
        fanout_button.addActionListener(e -> {
        ...
        whole_nets_button.addActionListener(e -> {
        ...
        whole_connected_sets_button.addActionListener(e -> {
        ...
        whole_connections_button.addActionListener(e -> {
        ...
        whole_groups_button.addActionListener(e -> {
        ...
        if (p_extended) {
            ...
            new_net_button.addActionListener(e -> {
            ...
            new_group_button.addActionListener(e -> {
        ...
        display_selection_button.addActionListener(e -> {
