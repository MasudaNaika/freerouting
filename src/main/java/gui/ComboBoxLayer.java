 ...
 * @author Alfons Wirtz
 */
public class ComboBoxLayer extends JComboBox {
    ...
    public ComboBoxLayer(LayerStructure p_layer_structure, Locale p_locale) {
        ResourceBundle resources
                = ResourceBundle.getBundle("gui.resources.Default", p_locale);
        ...
        layer_arr = new Layer[item_count];
        ...
        setModel(new DefaultComboBoxModel(layer_arr));
        setSelectedIndex(0);
    }
