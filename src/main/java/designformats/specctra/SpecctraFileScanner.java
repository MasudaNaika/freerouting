 ...
 * <a href="http://www.jflex.de/">JFlex</a> 1.4.1 on 16.10.08 09:27 from the
 * specification file
 * <tt>C:/Users/Public/Documents/router/sources/designformats/specctra/SpecctraFileDescription.flex</tt>
 */
public class SpecctraFileScanner implements Scanner {
     ...
     */
    public SpecctraFileScanner(InputStream in) {
        try (in) {
            byte[] bytes = in.readAllBytes();
            zzBuffer = new String(bytes, StandardCharsets.UTF_8);
