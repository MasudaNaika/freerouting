...
class PullTightAlgo45 extends PullTightAlgo {
    ...
    /**
     * Smoothens the 90 degree corners of p_polyline to 45 degree by cutting of
     * the 90 degree corner. The cutting of is so small, that no check is needed
     */
    ...
    /**
     * adds a line between at p_no to smoothen a 90 degree corner between
     * p_line_1 and p_line_2 to 45 degree. The distance of the new line to the
     * corner will be so small that no clearance check is necessary.
     */
     ...
     * of two intersecting diagonal lines. Returns null, if that is not
     * possible.
     */
     ...
     * adds a line between at p_no to smoothen a 90 degree corner between
     * p_line_1 and p_line_2 to 45 degree. The distance of the new line to the
     * corner will be so big that a clearance check is necessary.
     */
