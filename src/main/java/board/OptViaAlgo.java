...
public class OptViaAlgo {
     ...
     * p_trace_cost_arr == null, the horizontal and vertical trace costs will be
     * set to 1. Returns false, if the via was not changed.
     */
    ...
    /**
     * Optimisations for vias with only 1 connected Trace (Plane or Fanout
     * Vias).
     */
    ...
    /**
     * Tries to move the via into the direction of p_to_location as far as
     * possible Return the new location of the via, or null, if no move was
     * possible.
     */
    ...
    /**
     * Tries to reposition the via to a better location according to the trace
     * costs. Returns null, if no better location was found.
     */
    private static Point reposition_via(RoutingBoard p_board, Via p_via,
