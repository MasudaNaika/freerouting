...
public class CoordinateTransform implements Serializable {
    ...
    public CoordinateTransform(CoordinateTransform p_coordinate_transform) {
        ...
        design_box = new IntBox(p_coordinate_transform.design_box.ll, p_coordinate_transform.design_box.ur);
        rotation_pole = new FloatPoint(p_coordinate_transform.rotation_pole.x, p_coordinate_transform.rotation_pole.y);
        design_box_with_offset = new IntBox(p_coordinate_transform.design_box_with_offset.ll, p_coordinate_transform.design_box_with_offset.ur);
        ...
        rotation = p_coordinate_transform.rotation;
    }
    ...
    public Point2D board_to_screen(FloatPoint p_point) {
        FloatPoint rotated_point = p_point.rotate(rotation, rotation_pole);
    ...
    public FloatPoint screen_to_board(Point2D p_point) {
        ...
        return result.rotate(-rotation, rotation_pole);
    }
    ...
    public double board_to_screen_angle(double p_angle) {
        double result = p_angle + rotation;
        if (mirror_left_right) {
    ...
    public Rectangle board_to_screen(IntBox p_box) {
        ...
        Rectangle result
                = new Rectangle((int) Math.floor(ll_x), (int) Math.floor(ll_y),
    ...
    /**
     * If p_value is true, the left side and the right side of the board will be
     * swapped.
     */
    ...
    /**
     * If p_value is true, the top side and the botton side of the board will be
     * swapped.
     */
    ...
    /**
     * Returns the internal rotation snapped to the nearest multiple of 90
     * degree. The result will be 0, 1, 2 or 3.
     */
