...
public class InteractiveState {
    ...
    protected InteractiveState(InteractiveState p_return_state, BoardHandling p_board_handling, Logfile p_logfile) {
        ...
        logfile = p_logfile;
        resources
                = ResourceBundle.getBundle("interactive.resources.InteractiveState", p_board_handling.get_locale());
    }
    ...
    public InteractiveState complete() {
        if (return_state != this && logfile != null) {
    ...
    /**
     * Returns the popup menu from board_panel, which is used in this
     * interactive state. Default function to be overwritten in derived classes.
     */
