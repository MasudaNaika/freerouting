...
public class ExpansionDrill implements ExpandableObject {
     ...
     * CompleteFreeSpaceExpansionRoom, if no expansion room is found. Returns
     * false, if that was not possible because of an obstacle at this.location
    ...
    public boolean calculate_expansion_rooms(AutorouteEngine p_autoroute_engine) {
        ...
        for (int i = first_layer; i <= last_layer; ++i) {
            ...
            room_arr[i - first_layer] = found_room;
        }
        return true;
    }
