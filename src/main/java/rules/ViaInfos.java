...
/**
 * Contains the lists of different ViaInfo's, which can be used in interactive
 * and automatic routing.
 *
 * @author Alfons Wirtz
 */
public class ViaInfos implements Serializable, board.ObjectInfoPanel.Printable {

    /**
     * Adds a via info consisting of padstack, clearance class and
     * drill_to_smd_allowed. Return false, if the insertion failed, for example
     * if the name existed already.
     */
    ...
    /**
     * Returns true, if a via info with name p_name is already wyisting in the
     * list.
     */
    ...
    /**
     * Removes p_via_info from this list. Returns false, if p_via_info was not
