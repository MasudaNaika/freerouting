...
public class MoveComponent {
    ...
    public MoveComponent(Item p_item, Vector p_translate_vector, int p_max_recursion_depth, int p_max_via_recursion_depth) {
        ...
        if (component_no > 0) {
            ...
            component = board.components.get(component_no);
        } else {
        ...
        for (SortedItem sortedItem : item_group_arr) {
            ...
            if (sortedItem.item instanceof DrillItem) {
                ...
                if (translate_vector.length_approx() >= curr_drill_item.min_width()) {
                    ...
                    move_ok = MoveDrillItemAlgo.check(curr_drill_item, translate_vector,
                            max_recursion_depth, max_via_recursion_depth,
     ...
     * clearance violations. In this case an undo may be necessary.
     */
    public boolean insert(int p_tidy_width, int p_pull_tight_accuracy) {
        ...
        if (component != null) {
            ...
            board.components.move(component.no, translate_vector);
