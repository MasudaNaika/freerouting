    ...
    static class Circle extends PrintableShape {
        ...
        public String toString() {
            ...
            if (center.x != 0 || center.y != 0) {
                String center_string = resources.getString("center") + " =" + center.to_string(locale);
    ...
    static class Rectangle extends PrintableShape {
        ...
        public String toString() {
            ...
            String result = resources.getString("rectangle") + ": " + resources.getString("lower_left") + " = "
                    + lower_left.to_string(locale) + ", " + resources.getString("upper_right") + " = "
                    + upper_right.to_string(locale);
            return result;
        }
