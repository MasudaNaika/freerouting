 ...
 * array are preferred to later vias.
 *
 * @author Alfons Wirtz
 */
public class ViaRule implements Serializable, board.ObjectInfoPanel.Printable {
    ...
    /**
     * Removes p_via from the rule. Returns false, if p_via was not contained in
     * the rule.
     */
    ...
    /**
     * Searchs a via in this rule with first layer = p_from_layer and last layer
    ...
    /**
     * Swaps the locations of p_1 and p_2 in the rule. Returns false, if p_1 or
