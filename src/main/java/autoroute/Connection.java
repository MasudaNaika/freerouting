...
public class Connection {
     ...
     * fork or terminal item. Returns null, if p_item is not a route item, or if
     * it is a via belonging to more than 1 connection.
     */
    public static Connection get(Item p_item) {
        ...
        Set<Item> connection_items = Freerouter.newSortedSet();
    ...
    public double get_detour() {
        ...
        double detour = (trace_length() + DETOUR_ADD) / (min_trace_length + DETOUR_ADD)
