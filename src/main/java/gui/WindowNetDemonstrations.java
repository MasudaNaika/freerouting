...
public class WindowNetDemonstrations extends WindowNetSamples {
    ...
    /**
     * To be edited when the demonstration examples change. For every String in
     * the second column a String has to be added to the resource file
     * WindowNetSamples.
     */
    @Override
    ...
    protected void button_pushed() {
        ...
        BoardFrame new_frame = open_design(archive_name, selected_element.design_name, locale);
        if (new_frame != null) {
    ...
    /**
     * Structure of the elements in the list For every instance in a String has
     * to be added to the resource file WindowNetSamples fo the String in the
     * field message_name.
     */
