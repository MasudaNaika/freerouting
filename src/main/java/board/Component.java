 ...
 * @author Alfons Wirtz
 */
public class Component implements UndoableObjects.Storable, ObjectInfoPanel.Printable, Serializable, Cloneable {
    ...
    public void turn_90_degree(int p_factor, IntPoint p_pole) {
        ...
        rotation_in_degree = rotation_in_degree + p_factor * 90;
        while (rotation_in_degree >= 360) {
            rotation_in_degree -= 360;
        }
        while (rotation_in_degree < 0) {
    ...
    public void change_side(IntPoint p_pole) {
        on_front = !on_front;
        location = location.mirror_vertical(p_pole);
    }
    ...
    public int compareTo(Object p_other) {
        if (p_other instanceof Component) {
            return name.compareToIgnoreCase(((Component) p_other).name);
        }
        return 1;
    }
    ...
    public void print_info(ObjectInfoPanel p_window, Locale p_locale) {
        ...
        Package lib_package = get_package();
