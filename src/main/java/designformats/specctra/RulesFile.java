...
public class RulesFile {
    ...
    public static void write(interactive.BoardHandling p_board_handling, OutputStream p_output_stream, String p_design_name) {
    ...
    public static boolean read(InputStream p_input_stream, String p_design_name,
