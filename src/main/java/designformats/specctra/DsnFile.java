...
public class DsnFile {
     ...
     */
    public static ReadResult read(InputStream p_input_stream, interactive.IBoardHandling p_board_handling,
     ...
     */
    public static boolean write(interactive.BoardHandling p_board_handling, OutputStream p_file, String p_design_name, boolean p_compat_mode) {
