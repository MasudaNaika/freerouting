...
public class RouteState extends InteractiveState {
    ...
    /**
     * Returns a new instance of this class or null, if starting a new route was
     * not possible at p_location. If p_logfile != null, the creation of the
     * route is stored in the logfile.
     *
     */
    ...
    /**
     * Append a line to p_location to the trace routed so far. Returns from
     * state, if the route is completed by connecting to a target.
     */
