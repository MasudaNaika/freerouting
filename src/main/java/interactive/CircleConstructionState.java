...
public class CircleConstructionState extends InteractiveState {
    ...
    public InteractiveState complete() {
        IntPoint center = circle_center.round();
    ...
    /**
     * Used when reading the next point from a logfile. Calls complete, because
     * only 1 additional point is stored in the logfile.
     */
    @Override
