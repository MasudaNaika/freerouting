...
/**
 *
 * Contains internal auxiliary functions of class RoutingBoard for shoving vias
 * and pins
 *
 * @author Alfons Wirtz
 */
public class MoveDrillItemAlgo {
    ...
    /**
     * Translates p_drill_item by p_vector by shoving obstacle traces and vias
     * aside, so that no clearance violations occur. If p_tidy_region != null,
     * it will be joined by the bounding octagons of the translated shapes.
     */
    ...
    /**
     * Shoves vias out of p_obstacle_shape. Returns false, if the database is
     * damaged, so that an undo is necessary afterwards.
     */
    ...
    /**
     * Calculates possible new location for a via to shove outside
     * p_obstacle_shape. if p_extended_check is true, more than 1 possible new
     * locations are calculated. The function isused here and in
