...
/**
 * Stores information about the search trees of the board items, which is
...
class ItemSearchTreesInfo {
    ...
    public ShapeTree.Leaf[] get_tree_entries(ShapeTree p_tree) {
        for (SearchTreeInfo curr_tree_info : tree_list) {
    ...
    public void set_tree_entries(ShapeTree.Leaf[] p_tree_entries, ShapeTree p_tree) {
        ...
        tree_list.add(new_tree_info);
    }

    /**
     * Returns the precalculated tiles hapes for the tree with identification
     * number p_tree_no, or null, if the tile shapes of this tree are nnot yet
     * precalculated.
     */
    ...
    /**
     * clears the stored information about the precalculated tree shapes for all
     * search trees.
     */
