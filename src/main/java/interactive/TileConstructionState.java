...
public class TileConstructionState extends CornerItemConstructionState {
    ...
    /**
     * Returns a new instance of this class If p_logfile != null; the creation
     * of this item is stored in a logfile
     */
    ...
    private void remove_concave_corners() {
        ...
        IntPoint[] corner_arr = corner_list.toArray(IntPoint[]::new);
    ...
    /**
     * removes as many corners at the end of the corner list, so that closing
     * the polygon will not create a concave corner
     */
