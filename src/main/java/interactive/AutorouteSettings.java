...
public class AutorouteSettings implements Serializable {
    ...
    public AutorouteSettings(AutorouteSettings p_settings) {
        ...
        System.arraycopy(p_settings.layer_active_arr, 0, layer_active_arr, 0, layer_active_arr.length);
        preferred_direction_is_horizontal_arr = new boolean[p_settings.preferred_direction_is_horizontal_arr.length];
        System.arraycopy(p_settings.preferred_direction_is_horizontal_arr, 0, preferred_direction_is_horizontal_arr, 0,
