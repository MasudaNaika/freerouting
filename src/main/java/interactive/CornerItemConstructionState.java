...
public class CornerItemConstructionState extends InteractiveState {
    ...
    public InteractiveState add_corner(FloatPoint p_location) {
        IntPoint location = snap(p_location.round());
    ...
    /**
     * stores the location of the mouse pointer after snapping it to the
     * snap_angle
     */
    @Override
    public InteractiveState mouse_moved() {
        ...
        snapped_mouse_position = (snap(curr_mouse_pos)).to_float();
        hdlg.repaint();
        return this;
    }
