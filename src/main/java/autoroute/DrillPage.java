    ...
    public Collection<ExpansionDrill> get_drills(AutorouteEngine p_autoroute_engine, boolean p_attach_smd) {
        if (drills == null || p_autoroute_engine.get_net_no() != net_no) {
            ...
            for (TreeEntry curr_entry : overlaps) {
                ...
                if (curr_item.is_drillable(net_no)) {
                    continue;
                }
                ...
                if (!prev_obstacle_shape.contains(curr_obstacle_shape)) {
                    ...
                    TileShape curr_cutout_shape = curr_obstacle_shape.intersection(shape);
            ...
            TileShape[] holes = cutout_shapes.toArray(TileShape[]::new);
            PolylineArea shape_with_holes = new PolylineArea(shape, holes);
