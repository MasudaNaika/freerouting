...
public class Settings implements Serializable {
    ...
    public Settings(Settings p_settings) {
        logfile = p_settings.logfile;
        read_only = p_settings.read_only;
        layer = p_settings.layer;
        ...
        autoroute_settings = new AutorouteSettings(p_settings.autoroute_settings);
        item_selection_filter = new ItemSelectionFilter(p_settings.item_selection_filter);
        snapshot_attributes = new SnapShot.Attributes(p_settings.snapshot_attributes);
    }
    ...
    /**
     * Defines, if the setting attributes are allowed to be changed
