...
public class WindowDisplayMisc extends BoardSavableSubWindow {
    ...
    public WindowDisplayMisc(BoardFrame p_board_frame) {
        panel = p_board_frame.board_panel;
        ResourceBundle resources
                = ResourceBundle.getBundle("gui.resources.DisplayMisc", p_board_frame.get_locale());
        ...
        JLabel cursor_label = new JLabel("   " + resources.getString("cross_hair_cursor"));
        gridbag_constraints.gridwidth = GridBagConstraints.RELATIVE;
        ...
        JLabel rotation_label = new JLabel("   " + resources.getString("rotation"));
        gridbag_constraints.gridwidth = GridBagConstraints.RELATIVE;
        ...
        JLabel mirroring_label = new JLabel("   " + resources.getString("board_mirroring"));
        gridbag_constraints.gridwidth = GridBagConstraints.RELATIVE;
        ...
        JLabel auto_layer_dim_label = new JLabel(resources.getString("layer_dimming"));
        ...
        auto_layer_dim_slider = new JSlider(0, MAX_SLIDER_VALUE);
        gridbag.setConstraints(auto_layer_dim_slider, gridbag_constraints);
        main_panel.add(auto_layer_dim_slider);
        auto_layer_dim_slider.addChangeListener(new SliderChangeListener());
