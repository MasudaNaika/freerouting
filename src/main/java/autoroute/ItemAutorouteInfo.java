...
public class ItemAutorouteInfo {
    ...
    /**
     * Looks, if the corresponding item belongs to the start or destination set
     * of the autoroute algorithm. Only used, if the item belongs to the net,
     * which will be currently routed.
     */
    ...
    /**
     * Sets, if the corresponding item belongs to the start or destination set
     * of the autoroute algorithm. Only used, if the item belongs to the net,
     * which will be currently routed.
     */
    ...
    /**
     * Returns the precalculated connection of this item or null, if it is not
     * yet precalculated.
     */
    ...
    /**
     * Gets the ExpansionRoom of of index p_index. Creates it, if it is not yet
     * existing.
     */
    public ObstacleExpansionRoom get_expansion_room(int p_index, ShapeSearchTree p_autoroute_tree) {
        ...
        if (expansion_room_arr[p_index] == null) {
            expansion_room_arr[p_index] = new ObstacleExpansionRoom(item, p_index, p_autoroute_tree);
        }
    ...
    /**
     * Draws the shapes of the expansion rooms of this info for testing
     * purposes.
     */
