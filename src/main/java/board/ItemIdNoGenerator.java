 ...
 * @author Alfons Wirtz
 */
public class ItemIdNoGenerator implements datastructures.IdNoGenerator, Serializable {
    ...
    /**
     * Create a new unique identification number. Use eventually the id_no
     * generater from the host system for syncronisation
     */
    @Override
    public int new_no() {
