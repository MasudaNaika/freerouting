...
public interface ObjectInfoPanel {
    ...
    /**
     * Appends p_value to the window after transforming it to the user
     ...
     * sytem. Returns false, if that was not possible.
     */
    boolean append(geometry.planar.Shape p_shape, Locale p_locale);
     ...
     */
    boolean append_items(String p_link_name, String p_window_title, Collection<board.Item> p_items);
    ...
    boolean append_objects(String p_button_name, String p_window_title,
            Collection<Printable> p_objects);
