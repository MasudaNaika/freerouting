 ...
 * @author Alfons Wirtz
 */
public class LogicalPart implements board.ObjectInfoPanel.Printable, Serializable {
    ...
    public static class PartPin implements Comparable<PartPin>, Serializable {
        ...
        /**
         * The gate swap code. Gates with the same gate swap code can be
         * swapped. Gates with swap code <= 0 are not swappable.
         */
        ...
        /**
         * The pin swap code of the gate. Pins with the same pin swap code can
         * be swapped inside a gate. Pins with swap code <= 0 are not swappable.
         */
