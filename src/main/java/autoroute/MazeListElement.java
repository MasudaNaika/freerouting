...
public class MazeListElement implements Comparable<MazeListElement> {
    ...
    /**
     * The expansion value plus the shortest distance to a destination. The list
     * is sorted in ascending order by this value.
     */
    ...
    /**
     * Point of the region of the expansion door, which has the shortest
     * distance to the backtrack door.
     */
