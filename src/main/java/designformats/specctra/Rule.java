...
public abstract class Rule {
    ...
    public static void write_scope(rules.NetClass p_net_class, WriteScopeParameter p_par) throws IOException {
    ...
    private static void write_layer_rule(rules.NetClass p_net_class, int p_layer_no, WriteScopeParameter p_par) throws IOException {
        p_par.file.start_scope();
    ...
    /**
     * Write the clearance rules, which are different from the default
     * clearance.
     */
    private static void write_clearance_rules(WriteScopeParameter p_par,
            int p_layer, int p_cl_class, int p_max_cl_class, int p_default_clearance) throws IOException {
        ...
        for (int i = p_cl_class; i < p_max_cl_class; ++i) {
            ...
            p_par.file.new_line();
            p_par.file.write("(clear ");
            p_par.file.write(Double.toString(curr_clearance));
    ...
    static public void write_item_clearance_class(String p_name, datastructures.IndentFileWriter p_file,
            datastructures.IdentifierType p_identifier_type) throws IOException {
        p_file.new_line();
