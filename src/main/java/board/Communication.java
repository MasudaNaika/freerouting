...
public class Communication implements Serializable {
    ...
    public double get_resolution(Unit p_unit) {
        return Unit.scale(resolution, p_unit, unit);
    }
    ...
    /**
     * The resolution (1 / unit_factor) of the coordinate system, which is
     * imported from the host system.
     */
    ...
    /**
     * Information from the parser scope in a Specctra-dsn-file. The fields are
    ...
    public static class SpecctraParserInfo implements Serializable {
        ...
        public SpecctraParserInfo(String p_string_quote, String p_host_cad,
                String p_host_version, Collection<String[]> p_constants,
