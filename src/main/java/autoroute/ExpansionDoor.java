...
public class ExpansionDoor implements ExpandableObject {
    ...
    /**
     * Calculates the intersection of the shapes of the 2 rooms belonging to
     * this door.
     */
    @Override
    ...
    /**
     * The dimension of a door may be 1 or 2. 2-dimensional doors can only exist
     * between ObstacleExpansionRooms
     */
    @Override
    ...
    /**
     * Returns the other room of this door, or null, if p_roon is neither equal
     * to this.first_room nor to this.second_room.
     */
    ...
    /**
     * Returns the other room of this door, or null, if p_roon is neither equal
     * to this.first_room nor to this.second_room, or if the other room is not a
    ...
    public FloatLine[] get_section_segments(double p_offset) {
        ...
        TileShape door_shape = get_shape();
        {
        ...
        } else if (dimension == 2 && first_room instanceof CompleteFreeSpaceExpansionRoom && second_room instanceof CompleteFreeSpaceExpansionRoom) {
    ...
    /**
     * Calculates a diagonal line of the 2-dimensional p_door_shape which
     * represents the restraint line between the shapes of this.first_room and
     * this.second_room.
     */
    private FloatLine calc_door_line_segment(TileShape p_door_shape) {
        TileShape first_room_shape = first_room.get_shape();
        TileShape second_room_shape = second_room.get_shape();
