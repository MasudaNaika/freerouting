...
/**
 *
 * Analog RationalPoint, but implementing the functionality of a Vector instead
 * of the functionality of a Point.
 *
 * @author Alfons Wirtz
 */
public class RationalVector extends Vector implements Serializable {
     ...
     * vector and p_other > 0, Signum.NEGATIVE, if the scalar product is < 0,
    ...
    public Vector turn_90_degree(int p_factor) {
        ...
        return new RationalVector(new_x, new_y, z);
    }

    @Override
    public Vector mirror_at_y_axis() {
        return new RationalVector(x.negate(), y, z);
    }

    @Override
    public Vector mirror_at_x_axis() {
        return new RationalVector(x, y.negate(), z);
    }
    ...
    final Vector add(RationalVector p_other) {
        BigInteger v1[] = {x, y, z};
        BigInteger v2[] = {p_other.x, p_other.y, p_other.z};
    ...
    Point add_to(RationalPoint p_point) {
        BigInteger v1[] = {x, y, z};
        BigInteger v2[] = {p_point.x, p_point.y, p_point.z};
