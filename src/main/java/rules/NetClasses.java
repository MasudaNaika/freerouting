...
public class NetClasses implements Serializable {
    ...
    public NetClass get(String p_name) {
        for (NetClass curr_class : class_arr) {
     ...
     * created internally
     */
    NetClass append(board.LayerStructure p_layer_structure, ClearanceMatrix p_clearance_matrix, Locale p_locale) {
    ...
    /**
     * Looks, if the list contains a net class with trace half widths all equal
     * to p_trace_half_width, trace clearance class equal to
     * p_trace_clearance_class and via rule equal to p_cia_rule. Returns null,
     * if no such net class was found.
     */
     ...
     * equal to p_trace_half_width_arr[i] for 0 <= i < layer_count, trace
     * clearance class equal to p_trace_clearance_class and via rule equal to
     * p_via_rule. Returns null, if no such net class was found.
     */
