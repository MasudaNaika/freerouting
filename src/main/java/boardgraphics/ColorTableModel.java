...
public abstract class ColorTableModel extends AbstractTableModel {
    ...
    protected ColorTableModel(int p_row_count, Locale p_locale) {
        data = new Object[p_row_count][];
        locale = p_locale;
    }

    protected ColorTableModel(ObjectInputStream p_stream)
            throws IOException, ClassNotFoundException {
        data = (Object[][]) p_stream.readObject();
        locale = (Locale) p_stream.readObject();
    }
    ...
    protected void write_object(ObjectOutputStream p_stream)
            throws IOException {
        p_stream.writeObject(data);
        p_stream.writeObject(locale);
    }
