...
public class BoardMenuRules extends JMenu {
    ...
    public static BoardMenuRules get_instance(BoardFrame p_board_frame) {
        ...
        clearance_window.addActionListener(e -> {
        ...
        via_window.addActionListener(e -> {
        ...
        nets_window.addActionListener(e -> {
        ...
        net_class_window.addActionListener(e -> {
    ...
    private BoardMenuRules(BoardFrame p_board_frame) {
        ...
        resources = ResourceBundle.getBundle("gui.resources.BoardMenuRules", p_board_frame.get_locale());
    }
