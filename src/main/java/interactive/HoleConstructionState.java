...
public class HoleConstructionState extends CornerItemConstructionState {
    ...
    private boolean start_ok(FloatPoint p_location) {
        ...
        Collection<board.Item> found_items = hdlg.get_routing_board().pick_items(pick_location,
        ...
        item_to_modify = (ObstacleArea) found_item;
    ...
    public InteractiveState complete() {
        ...
        if (construction_succeeded) {
            IntPoint[] new_hole_corners = corner_list.toArray(IntPoint[]::new);
